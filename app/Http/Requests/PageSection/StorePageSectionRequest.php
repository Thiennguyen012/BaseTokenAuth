...
/**
 * @OA\Schema(
 *     schema="StorePageSectionRequest",
 *     required={"page_content_id"},
 *     @OA\Property(property="page_content_id", type="integer", example=1),
 *     @OA\Property(property="title", type="string", maxLength=255, nullable=true, example="Mục Banner"),
 *     @OA\Property(property="subtitle", type="string", maxLength=255, nullable=true, example="Mục hình ảnh chính"),
 *     @OA\Property(property="content", type="string", nullable=true, example="Mô tả cho mục"),
 *     @OA\Property(
 *         property="files[]",
 *         type="array",
 ...
 *         type="string",
 *         nullable=true,
 *         description="Chuỗi JSON hoặc URL ngoài tùy chọn"
 *     ),
 *     @OA\Property(property="sort_order", type="integer", default=0, example=0)
 * )
 */
