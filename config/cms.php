...
return [
    'modules' => [
        'products' => [
            ...
            'fields' => [
                ['name' => 'product_name', 'label' => 'Tên sản phẩm', 'type' => 'text', 'required' => true, 'placeholder' => 'Nhập tên sản phẩm', 'column_class' => 'col-12'],
                ['name' => 'description', 'label' => 'Mô tả', 'type' => 'richtext', 'placeholder' => 'Nhập mô tả chi tiết về sản phẩm...'],
                ['name' => 'category_ids', 'label' => 'Danh mục sản phẩm', 'type' => 'multi_select_api', 'source' => 'categories', 'value' => 'id', 'text' => 'category_name', 'placeholder' => 'Nhập tên danh mục để tìm kiếm'],
                ...
                ['name' => 'is_active', 'label' => 'Đang hoạt động', 'type' => 'checkbox', 'column_class' => 'col-md-4'],
                ['name' => 'is_featured', 'label' => 'Sản phẩm nổi bật', 'type' => 'checkbox', 'column_class' => 'col-md-4'],
                ['name' => 'is_contact_price', 'label' => 'Giá liên hệ / Báo giá', 'type' => 'checkbox', 'column_class' => 'col-md-4'],
        ...
        'tag-groups' => [
            'title' => 'Nhóm nhãn', 'description' => 'Quản lý các loại/nhóm nhãn sản phẩm.', 'api' => 'tag-groups',
            'columns' => ['name' => 'Tên nhóm nhãn', 'code' => 'Mã nhóm (Code)', 'sort_order' => 'Thứ tự'],
            'fields' => [
                ['name' => 'name', 'label' => 'Tên nhóm nhãn', 'type' => 'text', 'required' => true, 'placeholder' => 'Ví dụ: Chất liệu, Đặc tính, Ứng dụng'],
                ['name' => 'code', 'label' => 'Mã nhóm nhãn (Code)', 'type' => 'text', 'placeholder' => 'Ví dụ: material, feature, usage (tự tạo nếu để trống)'],
                ['name' => 'sort_order', 'label' => 'Thứ tự hiển thị', 'type' => 'number', 'default' => 0],
            ],
        ],
        'tags' => [
            'title' => 'Nhãn sản phẩm', 'description' => 'Quản lý các thẻ/nhãn dán cho sản phẩm.', 'api' => 'tags',
            'filters' => [['name' => 'tag_group_id', 'label' => 'Tất cả nhóm nhãn', 'source' => 'tag-groups', 'value' => 'id', 'text' => 'name']],
            'columns' => ['name' => 'Tên nhãn', 'tag_group_name' => 'Nhóm nhãn', 'slug' => 'Slug'],
            'fields' => [
                ['name' => 'name', 'label' => 'Tên nhãn', 'type' => 'text', 'required' => true, 'placeholder' => 'Ví dụ: Hàng bán chạy, Khuyến mãi, HDPE'],
                ['name' => 'tag_group_id', 'label' => 'Nhóm nhãn', 'type' => 'searchable_select_api', 'source' => 'tag-groups', 'value' => 'id', 'text' => 'name', 'selected_text' => 'tag_group_name', 'search_variant' => 'simple', 'column_class' => 'col-md-6', 'placeholder' => 'Nhập tên nhóm nhãn để tìm kiếm'],
                ['name' => 'slug', 'label' => 'Slug nhãn', 'type' => 'text', 'placeholder' => 'Tự động tạo nếu để trống (ví dụ: hang-ban-chay)'],
            ],
        ],
        'customer-contacts' => [
        ...
        'page-configs' => [
            ...
            'fields' => [
                ...
                ['name' => 'favicon', 'label' => 'Favicon', 'type' => 'single_file', 'column_class' => 'col-md-6', 'break_before' => true, 'accept' => 'image/png,image/x-icon,image/jpeg,image/webp'],
                ['name' => 'logo', 'label' => 'Logo', 'type' => 'single_file', 'column_class' => 'col-md-6', 'accept' => 'image/png,image/jpeg,image/webp'],
